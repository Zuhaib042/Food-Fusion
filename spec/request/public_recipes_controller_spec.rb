...
RSpec.describe PublicRecipesController, type: :request do
  before(:each) do
    ...
    @user2.confirmed_at
    @recipe = Recipe.create(name: 'pizza', preparation_time: '1 Hour', cooking_time: '2 hour', description: 'This is  the first recipe', public: true, created_at: Time.now, updated_at: Time.now, user_id: @user_id )      
    @recipe2 = Recipe.create(name: 'chicken', preparation_time: '1 Hour', cooking_time: '2 hour', description: 'This is  the second recipe', public: true, created_at: Time.now, updated_at: Time.now, user_id: @user_id )      
    @recipe3 = Recipe.create(name: 'fish', preparation_time: '1 Hour', cooking_time: '2 hour', description: 'This is  the third recipe', public: true, created_at: Time.now, updated_at: Time.now, user_id: @user_id )        
